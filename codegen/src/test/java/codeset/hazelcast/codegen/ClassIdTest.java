...
import sungard.hazelcast.codegen.ClassIdMethod;
...
public class ClassIdTest {
    ...
    public void testGenerate() throws JClassAlreadyExistsException {
        ...
        assertNotNull(result1.getMethod("getClassId", new JType[] {}));
        assertNotNull(result1.getMethod("getClassId", new JType[] {}).type().equals(codeModel.ref(Integer.class)));

        assertNotNull(result2.getMethod("getClassId", new JType[] {}));
        assertNotNull(result2.getMethod("getClassId", new JType[] {}).type().equals(codeModel.ref(Integer.class)));

        assertNotNull(result3.getMethod("getClassId", new JType[] {}));
        assertNotNull(result3.getMethod("getClassId", new JType[] {}).type().equals(codeModel.ref(Integer.class)));
