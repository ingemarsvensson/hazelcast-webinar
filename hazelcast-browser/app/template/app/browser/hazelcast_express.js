...
// // Create a new Asset
// var jsonString = "{ticker: '1234', asOfTime: " + new Date().getTime() + "}";
...
// map.values(new SqlPredicateClass("ticker = '1234'"), function(error, result) {
// 	console.log("Result for ticker " + record.ticker + ":");
// 	console.log(result.toArraySync());
// });
